...
declare class User {
      ...
      */
      ...
      verify(options: {type: String, to: String, from: String, subject: String, text: String, template: String, templateFn: Function, redirect: String, generateVerificationToken: Function}, fn: (err: Error, object: Object) => void):void;
